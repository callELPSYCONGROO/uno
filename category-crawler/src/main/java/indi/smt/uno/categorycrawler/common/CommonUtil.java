package indi.smt.uno.categorycrawler.common;
...
public class CommonUtil {
	...
	public final static String VOD_TYPE_HTML = "https://usa-10.us/vodtypehtml/";

	public final static String CATEGORY_URL = VOD_TYPE_HTML + "{categoryAndPageNumHtml}";
